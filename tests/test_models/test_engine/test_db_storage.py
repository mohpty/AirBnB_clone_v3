...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Test that get"""
        newState = State(name="bahri")
        newState.save()
        newUser = User(email="test@example.com", password="password")
        newUser.save()
    ...
    def test_count(self):
        ...
        newState = State(name="khartoum")
        newState.save()
        newUser = User(email="gddora@gmail.com", password="pass")
        newUser.save()
